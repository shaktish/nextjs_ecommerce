...
import getAllProductsAdmin from "@/modules/admin/products/api/getAllProductAdmin";
import DeleteProductButton from "@/modules/admin/products/list/DeleteProductButton";

async function ProductListAdmin() {
                ...
                {products?.map((item) => (
                  ...
                  >
                    <div className="absolute top-5 right-5 flex gap-2 opacity-0 group-hover:opacity-100 transition">
                      <Link href={`/admin/products/add?id=${item.id}`}>
